  ...
  return (
    <Layout title={siteTitle} location={location}>
      ...
      <ul>
        ...
        <li>
          <p><strong>Application</strong> refers to Kumaoni, the software program provided by the Company.</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Kumaoni.</p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: contact@dailycommit.dev</li>
      </ul>
    </Layout>
  )
}
